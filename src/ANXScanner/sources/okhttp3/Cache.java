...
public final class Cache implements Closeable, Flushable {
    ...
    private static final class Entry {
        ...
        public Response response(Snapshot snapshot) {
            String contentType = this.responseHeaders.get(Protocol.CONTENT_TYPE);
            String contentLength = this.responseHeaders.get(Protocol.CONTENT_LENGTH);
    ...
    CacheRequest put(Response response) {
        ...
        } else if (!requestMethod.equals(SpdyRequest.GET_METHOD) || HttpHeaders.hasVaryAll(response)) {
            return null;
        } else {
