...
public class TBAppLinkUtil {
    ...
    public static String getPackageName(String str) {
        ...
        return (!TAOBAO_SCHEME.equals(str) && TMALL_SCHEME.equals(str)) ? TMALLPACKAGENAME : str2;
    }

    public static String getServerAction(String str) {
        String str2 = START_SERVER_ACTION;
        return (!TAOBAO_SCHEME.equals(str) && TMALL_SCHEME.equals(str)) ? TMALL_START_SERVER_ACTION : str2;
    }
    ...
    public static boolean isSupportAppLinkSDK(Context context, String str) {
        ...
        return !isSupportTaobao ? isSupportTaobao(context) : isSupportTaobao;
    }
    ...
    private static boolean isSupportTaobao(Context context) {
        ...
        try {
            return packageManager.getPackageInfo(TAOPACKAGENAME, 0) != null && packageManager.queryIntentActivities(intent, 65536).size() > 0;
        } catch (Exception e) {
            Log.d(TAG, e.toString());
            return false;
        }
    ...
    private static boolean isSupportTmall(Context context) {
        ...
        try {
            return packageManager.getPackageInfo(TMALLPACKAGENAME, 0) != null && packageManager.queryIntentActivities(intent, 65536).size() > 0;
        } catch (Exception e) {
            Log.d(TAG, e.toString());
            return false;
        }
