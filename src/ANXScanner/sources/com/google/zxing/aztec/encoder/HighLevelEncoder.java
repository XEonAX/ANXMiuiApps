...
public final class HighLevelEncoder {
    ...
    static {
        ...
        CHAR_MAP[1][32] = 1;
        for (c = 97; c <= SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE; c++) {
            CHAR_MAP[1][c] = (c - 97) + 2;
        }
        CHAR_MAP[2][32] = 1;
        for (c = 48; c <= 57; c++) {
        ...
        mixedTable[23] = 95;
        mixedTable[24] = 96;
        mixedTable[25] = SecExceptionCode.SEC_ERROR_INIT_LOW_VERSION_DATA;
        mixedTable[26] = Opcodes.IAND;
        mixedTable[27] = DecodeType.ONE;
        ...
        punctTable[27] = 91;
        punctTable[28] = 93;
        punctTable[29] = SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE;
        punctTable[30] = SecExceptionCode.SEC_ERROR_INIT_PARSE_USER_CONFIG_ERROR;
