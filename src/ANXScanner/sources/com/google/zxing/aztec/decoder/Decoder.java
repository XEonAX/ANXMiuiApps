...
import com.xiaomi.scanner.camera.exif.ExifInterface.GpsSpeedRef;
...
public final class Decoder {
    ...
    private static final String[] DIGIT_TABLE = new String[]{"CTRL_PS", " ", "0", "1", "2", "3", AlibcJsResult.NO_PERMISSION, AlibcJsResult.TIMEOUT, AlibcJsResult.FAIL, AlibcJsResult.CLOSED, AlibcJsResult.APP_NOT_INSTALL, "9", ",", SymbolExpUtil.SYMBOL_DOT, "CTRL_UL", "CTRL_US"};
    private static final String[] LOWER_TABLE = new String[]{"CTRL_PS", " ", "a", "b", "c", "d", AppLinkConstants.E, "f", "g", "h", "i", "j", "k", "l", "m", "n", "o", "p", "q", "r", "s", LoginConstants.TIMESTAMP, "u", "v", "w", "x", "y", "z", "CTRL_US", "CTRL_ML", "CTRL_DL", "CTRL_BS"};
    private static final String[] MIXED_TABLE = new String[]{"CTRL_PS", " ", "\u0001", "\u0002", "\u0003", "\u0004", Constants.COOKIE_SPLIT, "\u0006", "\u0007", "\b", "\t", "\n", "\u000b", "\f", "\r", "\u001b", "\u001c", "\u001d", "\u001e", "\u001f", "@", "\\", "^", LoginConstants.UNDER_LINE, "`", SymbolExpUtil.SYMBOL_VERTICALBAR, "~", "", "CTRL_LL", "CTRL_UL", "CTRL_PL", "CTRL_BS"};
    private static final String[] PUNCT_TABLE = new String[]{"", "\r", "\r\n", ". ", ", ", ": ", "!", "\"", "#", SymbolExpUtil.SYMBOL_DOLLAR, "%", "&", "'", "(", ")", "*", "+", ",", "-", SymbolExpUtil.SYMBOL_DOT, "/", SymbolExpUtil.SYMBOL_COLON, ";", "<", "=", ">", "?", "[", "]", "{", h.d, "CTRL_UL"};
