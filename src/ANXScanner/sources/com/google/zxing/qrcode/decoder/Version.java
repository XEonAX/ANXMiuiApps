...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, 120), new ECB(1, SecExceptionCode.SEC_ERROR_INIT_DATA_FILE_MISMATCH));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, SecExceptionCode.SEC_ERROR_INIT_DATA_FILE_MISMATCH), new ECB(5, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE), new ECB(4, SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE));
        ...
        iArr = new int[]{6, 26, 50, 74, 98, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, 102, Opcodes.IAND, SecExceptionCode.SEC_ERROR_INIT_NO_ANNOTATION};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, SecExceptionCode.SEC_ERROR_INIT_DATA_FILE_MISMATCH), new ECB(7, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, SecExceptionCode.SEC_ERROR_INIT_DATA_FILE_MISMATCH), new ECB(14, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE), new ECB(4, SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, SecExceptionCode.SEC_ERROR_INIT_NO_DATA_FILE), new ECB(18, SecExceptionCode.SEC_ERROR_INIT_INCORRECT_DATA_FILE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, 118), new ECB(6, SecExceptionCode.SEC_ERROR_SET_GLOBAL_USER_DATA));
