                ...
                switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 5)) {
                    ...
                    default:
                        switch (GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 7)) {
                            case 56:
                                return new AI013x0x1xDecoder(information, "310", AlibcTrade.ERRCODE_PAGE_NATIVE);
                            case 57:
                                return new AI013x0x1xDecoder(information, "320", AlibcTrade.ERRCODE_PAGE_NATIVE);
                            case 58:
