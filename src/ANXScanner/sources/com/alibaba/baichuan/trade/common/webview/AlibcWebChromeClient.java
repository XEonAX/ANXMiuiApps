...
public class AlibcWebChromeClient extends WebChromeClient {
    ...
    public boolean onConsoleMessage(ConsoleMessage consoleMessage) {
        ...
        return (onConsoleMessage || AlibcWebViewService.onConsoleMessage((WebView) this.b.get(), consoleMessage, onConsoleMessage)) ? true : super.onConsoleMessage(consoleMessage);
    }
    ...
    public void onExceededDatabaseQuota(String str, String str2, long j, long j2, long j3, QuotaUpdater quotaUpdater) {
        ...
        AlibcWebViewService.onExceededDatabaseQuota((WebView) this.b.get(), str, str2, j, j2, j3, quotaUpdater);
    ...
    public void onGeolocationPermissionsShowPrompt(String str, Callback callback) {
        ...
        AlibcWebViewService.onGeolocationPermissionsShowPrompt((WebView) this.b.get(), str, callback);
    ...
    public boolean onJsPrompt(WebView webView, String str, String str2, String str3, JsPromptResult jsPromptResult) {
        ...
        return (z || AlibcWebViewService.onJsPrompt(webView, str, str2, str3, jsPromptResult, z)) ? true : super.onJsPrompt(webView, str, str2, str3, jsPromptResult);
    }
