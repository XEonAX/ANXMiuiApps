...
public class AlibcWebViewClient extends WebViewClient {
    ...
    public boolean shouldOverrideUrlLoading(WebView webView, String str) {
        ...
        AlibcLogger.d("AlibcWebViewClient", "代理webviewClient处理 result =" + z);
        boolean shouldOverrideUrlLoading = AlibcWebViewService.shouldOverrideUrlLoading(webView, str, z);
        AlibcLogger.d("AlibcWebViewClient", "拦截器处理处理 proxyResult =" + shouldOverrideUrlLoading);
        return (z || shouldOverrideUrlLoading) ? true : super.shouldOverrideUrlLoading(webView, str);
    }
}
