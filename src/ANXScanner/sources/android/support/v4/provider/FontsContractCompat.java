...
public class FontsContractCompat {
    ...
    static FontInfo[] getFontFromProvider(Context context, FontRequest request, String authority, CancellationSignal cancellationSignal) {
        ...
        Uri uri = new Builder().scheme(MaConstants.UT_PARAM_KEY_CONTENT).authority(authority).build();
        Uri fileBaseUri = new Builder().scheme(MaConstants.UT_PARAM_KEY_CONTENT).authority(authority).appendPath("file").build();
        Cursor cursor = null;
        try {
