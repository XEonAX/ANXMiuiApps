            ...
            switch (obj) {
                ...
                case 1:
                    if (args == null || !args.containsKey(MediaSessionCompat.ARGUMENT_MEDIA_ATTRIBUTE)) {
                        throw new IllegalArgumentException("An extra field android.support.v4.media.session.ARGUMENT_MEDIA_ATTRIBUTE is required for this action " + action + SymbolExpUtil.SYMBOL_DOT);
                    }
                    return;
                default:
                    return;
