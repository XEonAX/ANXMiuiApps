...
public class LongScreenshotUtils {
    ...
    public static class ContentPort {
        ...
        private boolean checkNeedFakeTouchForScroll() {
            ...
            if ((this.mMainScrollView instanceof AbsoluteLayout) && (VERSION.SDK_INT <= 19 || "com.ucmobile".equalsIgnoreCase(this.mMainScrollView.getContext().getPackageName()) || Constants.ALIPAY_PACKAGE_NAME.equalsIgnoreCase(this.mMainScrollView.getContext().getPackageName()))) {
                return false;
            }
            return true;
        }
