...
public class ANXAudioSystem {
    ...
    public static final int DEFAULT_MUTE_STREAMS_AFFECTED = 2095;
    public static int[] DEFAULT_STREAM_VOLUME = new int[]{4, 7, 5, 5, 6, 5, 7, 7, 5, 5, 5, 5};
    ...
    public static final int FORCE_EARPIECE = 16;
    ...
    public static final int FOR_LOOPBACK = 10;
    public static final int FOR_MEDIA = 1;
    public static final int FOR_RECORD = 2;
    public static final int FOR_RING = 9;
    ...
    private static final int NUM_FORCE_USE = 11;
    ...
    public static final String[] STREAM_NAMES = new String[]{"STREAM_VOICE_CALL", "STREAM_SYSTEM", "STREAM_RING", "STREAM_MUSIC", "STREAM_ALARM", "STREAM_NOTIFICATION", "STREAM_BLUETOOTH_SCO", "STREAM_SYSTEM_ENFORCED", "STREAM_DTMF", "STREAM_TTS", "STREAM_ACCESSIBILITY", "STREAM_VOICEASSIST"};
    public static final int STREAM_NOTIFICATION = 5;
    public static final int STREAM_RING = 2;
    public static final int STREAM_SYSTEM = 1;
    public static final int STREAM_SYSTEM_ENFORCED = 7;
    public static final int STREAM_TTS = 9;
    public static final int STREAM_VOICEASSIST = 11;
    public static final int STREAM_VOICE_CALL = 0;
    public static final int SUCCESS = 0;
    public static final int SYNC_EVENT_NONE = 0;
    public static final int SYNC_EVENT_PRESENTATION_COMPLETE = 1;
    private static final String TAG = "ANXAudioSystem";
    ...
    public static void setErrorCallback(ErrorCallback cb) {
        synchronized (ANXAudioSystem.class) {
            mErrorCallback = cb;
            if (cb != null) {
    ...
    public static String getOutputDeviceName(int device) {
        switch (device) {
            ...
            case DEVICE_OUT_PROXY /*33554432*/:
                return "proxy";
            case DEVICE_OUT_USB_HEADSET /*67108864*/:
                return "usb_headset";
            case DEVICE_OUT_HEARING_AID /*134217728*/:
    ...
    public static int getPlatformType(Context context) {
        if (context.getResources().getBoolean(17957076)) {
            return 1;
        }
    ...
    public static boolean isSingleVolume(Context context) {
        return getPlatformType(context) == 2 || context.getResources().getBoolean(17957028);
    }
}
