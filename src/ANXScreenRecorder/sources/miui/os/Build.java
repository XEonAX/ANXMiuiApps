...
public class Build extends android.os.Build {
    ...
    public static final boolean IS_CTA_BUILD = ScreenRecorderConfig.MIC_SOUND.equals(SystemProperties.get("ro.miui.cta"));
    public static final boolean IS_CTS_BUILD = (SystemProperties.getBoolean("persist.sys.miui_optimization", ScreenRecorderConfig.MIC_SOUND.equals(SystemProperties.get("ro.miui.cts")) ^ true) ^ true);
    ...
    public static final boolean IS_FUNCTION_LIMITED = ScreenRecorderConfig.MIC_SOUND.equals(SystemProperties.get("persist.sys.func_limit_switch"));
