...
.method public onPrepare(Ljava/util/List;Ljava/util/List;)Z
    ...
    invoke-virtual {v0, v1, v2, v13}, Lcom/miui/gallery/card/scenario/time/recent/LastMonthScenario;->getRecordStartTimesFromRecordAndCards(Ljava/util/List;Ljava/util/List;Z)Ljava/util/List;
    ...
    invoke-static/range {v13 .. v16}, Lcom/miui/gallery/card/scenario/DateUtils;->getLastNYearMonthTime(IJZ)J

    move-result-wide v10

    .line 34
    .local v10, "lastMonthStart":J
    const/4 v13, 0x0
    ...
    .line 42
    .end local v8    # "lastMonthEnd":J
    .end local v10    # "lastMonthStart":J
    :goto_0
    return v13

    .line 38
    .restart local v8    # "lastMonthEnd":J
    .restart local v10    # "lastMonthStart":J
    :cond_1
    move-object/from16 v0, p0

    invoke-virtual {v0, v10, v11}, Lcom/miui/gallery/card/scenario/time/recent/LastMonthScenario;->setStartTime(J)V

    .line 39
    move-object/from16 v0, p0

    invoke-virtual {v0, v8, v9}, Lcom/miui/gallery/card/scenario/time/recent/LastMonthScenario;->setEndTime(J)V
