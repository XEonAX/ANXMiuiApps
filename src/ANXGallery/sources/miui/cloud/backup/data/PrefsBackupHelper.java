        ...
        for (PrefEntry entry : entries) {
            ...
            if (value != null) {
                if (value.getClass() == entry.getValueClass()) {
                    ...
                    stringBuilder.append("Preference type of ");
                    stringBuilder.append(entry.getLocalKey());
                    stringBuilder.append(" mismatched. actual type = ");
                    stringBuilder.append(value.getClass().getSimpleName());
                    stringBuilder.append(", expected type = ");
                    stringBuilder.append(entry.getValueClass().getSimpleName());
    ...
    public static void restore(SharedPreferences prefs, DataPackage dataPackage, PrefEntry[] entries) {
        ...
        for (PrefEntry entry : entries) {
            ...
            try {
                ...
                stringBuilder.append(entry.getCloudKey());
                stringBuilder.append(" is not KeyStringSettingItem");
                Log.e(value, stringBuilder.toString());
            }
        }
        editor.commit();
    }
