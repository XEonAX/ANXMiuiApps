...
public class MimeUtils {
    private static final Map<String, String> Cy = new HashMap();
    private static final Map<String, String> Cz = new HashMap();
    ...
    static {
        ...
        add("application/x-wais-source", AQIInfo.SRC);
        ...
        add("audio/prs.sid", TagYellowPage.YID);
        ...
        add("text/x-csh", "csh");
        add("text/x-csrc", "c");
        add("text/x-dsrc", MiCloudSmsCmd.TYPE_DISCARD_TOKEN);
    ...
    private static InputStream cB() {
        ...
        stringBuilder.append("content-types.properties");
        File file2 = new File(property2, stringBuilder.toString());
        if (file2.exists()) {
            try {
    ...
    public static boolean hasMimeType(String str) {
        return (str == null || str.isEmpty() || !Cy.containsKey(str)) ? false : true;
    }

    public static String guessMimeTypeFromExtension(String str) {
        return (str == null || str.isEmpty()) ? null : (String) Cz.get(str);
    }

    public static boolean hasExtension(String str) {
        return (str == null || str.isEmpty() || !Cz.containsKey(str)) ? false : true;
    }

    public static String guessExtensionFromMimeType(String str) {
        return (str == null || str.isEmpty()) ? null : (String) Cy.get(str);
    }
}
