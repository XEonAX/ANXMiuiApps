...
/* renamed from: miui.os.SystemProperties */
public class C0004SystemProperties {
    private static final ArrayList<Runnable> Ej = new ArrayList();
    public static final int PROP_NAME_MAX = 31;
    public static final int PROP_VALUE_MAX = 91;

    protected C0004SystemProperties() throws InstantiationException {
    ...
    public static void set(String str, int i) {
        C0004SystemProperties.set(str, Integer.toString(i));
    }

    public static void set(String str, long j) {
        C0004SystemProperties.set(str, Long.toString(j));
    }

    public static void set(String str, boolean z) {
        C0004SystemProperties.set(str, Boolean.toString(z));
    }

    public static void addChangeCallback(Runnable runnable) {
        synchronized (Ej) {
            if (Ej.size() == 0) {
                Native.addPropertyChangeCallbackNative(C0004SystemProperties.class);
            }
            Ej.add(runnable);
        }
    }
