...
/* renamed from: miui.os.Build */
public class C0015Build extends Build {
    ...
    public static final boolean IS_CM_CUSTOMIZATION_TEST = "cm".equals(C0004SystemProperties.get("ro.cust.test"));
    public static final boolean IS_CTA_BUILD = "1".equals(C0004SystemProperties.get("ro.miui.cta"));
    public static final boolean IS_CTS_BUILD = (C0004SystemProperties.getBoolean("persist.sys.miui_optimization", "1".equals(C0004SystemProperties.get("ro.miui.cts")) ^ true) ^ true);
    public static final boolean IS_CT_CUSTOMIZATION = "ct".equals(C0004SystemProperties.get("ro.carrier.name"));
    public static final boolean IS_CT_CUSTOMIZATION_TEST = "ct".equals(C0004SystemProperties.get("ro.cust.test"));
    public static final boolean IS_CU_CUSTOMIZATION = "cu".equals(C0004SystemProperties.get("ro.carrier.name"));
    public static final boolean IS_CU_CUSTOMIZATION_TEST = "cu".equals(C0004SystemProperties.get("ro.cust.test"));
    public static final boolean IS_DEBUGGABLE = (C0004SystemProperties.getInt("ro.debuggable", 0) == 1);
    public static final boolean IS_DEVELOPMENT_VERSION;
    public static final boolean IS_FUNCTION_LIMITED = "1".equals(C0004SystemProperties.get("persist.sys.func_limit_switch"));
    public static final boolean IS_GLOBAL_BUILD = C0004SystemProperties.get("ro.product.mod_device", "").endsWith("_global");
    ...
    public static final boolean IS_INTERNATIONAL_BUILD = C0004SystemProperties.get("ro.product.mod_device", "").contains("_global");
    ...
    public static final boolean IS_MIUI = (C0004SystemProperties.get("ro.miui.ui.version.code", "").isEmpty() ^ true);
    ...
    public static final boolean IS_PRO_DEVICE = C0004SystemProperties.get("ro.miui.cust_device", "").endsWith("_pro");
    public static final boolean IS_STABLE_VERSION;
    public static final boolean IS_TABLET = C0015Build.isTablet();
    ...
    public static final String USERDATA_IMAGE_VERSION_CODE = C0015Build.getUserdataImageVersionCode();
    ...
    protected C0015Build() throws InstantiationException {
    ...
    static {
        ...
        IS_HONGMI_THREE = z;
        z = IS_HONGMI_THREE_LTE && "LTETD".equals(C0004SystemProperties.get("ro.boot.modem"));
        IS_HONGMI_THREE_LTE_CM = z;
        z = IS_HONGMI_THREE_LTE && "LTEW".equals(C0004SystemProperties.get("ro.boot.modem"));
        ...
        IS_HONGMI_TWOX = z;
        z = IS_HONGMI_THREEX && "cm".equals(C0004SystemProperties.get("persist.sys.modem"));
        IS_HONGMI_THREEX_CM = z;
        z = IS_HONGMI_THREEX && "cu".equals(C0004SystemProperties.get("persist.sys.modem"));
        IS_HONGMI_THREEX_CU = z;
        z = IS_HONGMI_THREEX && "ct".equals(C0004SystemProperties.get("persist.sys.modem"));
        ...
        IS_HONGMI = z;
        z = IS_MIONE && C0015Build.hasMsm8660Property();
        IS_MIONE_CDMA = z;
        z = IS_MITWO && "CDMA".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MITWO_CDMA = z;
        z = IS_MITHREE && "MI 3C".equals(MODEL);
        IS_MITHREE_CDMA = z;
        z = IS_MIFOUR && "CDMA".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MIFOUR_CDMA = z;
        z = IS_MITWO && "TD".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MITWO_TDSCDMA = z;
        z = IS_MITHREE && "TD".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MITHREE_TDSCDMA = z;
        z = IS_MIFOUR && "LTE-CMCC".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MIFOUR_LTE_CM = z;
        z = IS_MIFOUR && "LTE-CU".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MIFOUR_LTE_CU = z;
        z = IS_MIFOUR && "LTE-CT".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MIFOUR_LTE_CT = z;
        z = IS_MIFOUR && "LTE-India".equals(C0004SystemProperties.get("persist.radio.modem"));
        IS_MIFOUR_LTE_INDIA = z;
        z = IS_MIFOUR && "LTE-SEAsa".equals(C0004SystemProperties.get("persist.radio.modem"));
        ...
        IS_TDS_CDMA = z;
        z = "cm".equals(C0004SystemProperties.get("ro.carrier.name")) && ("cn_chinamobile".equals(C0004SystemProperties.get("ro.miui.cust_variant")) || "cn_cta".equals(C0004SystemProperties.get("ro.miui.cust_variant")));
        IS_CM_CUSTOMIZATION = z;
        z = "cm".equals(C0004SystemProperties.get("ro.carrier.name")) && "cn_cmcooperation".equals(C0004SystemProperties.get("ro.miui.cust_variant"));
        IS_CM_COOPERATION = z;
        z = !TextUtils.isEmpty(VERSION.INCREMENTAL) && VERSION.INCREMENTAL.matches("\\d+.\\d+.\\d+(-internal)?");
    ...
    public static boolean checkRegion(String region) {
        return C0015Build.getRegion().equalsIgnoreCase(region);
    }

    private static boolean hasMsm8660Property() {
        String soc = C0004SystemProperties.get("ro.soc.name");
        return "msm8660".equals(soc) || "unkown".equals(soc);
    }

    private static boolean isTablet() {
        return C0004SystemProperties.get("ro.build.characteristics").contains("tablet");
    }

    public static boolean hasCameraFlash(Context context) {
        return C0016FeatureParser.getBoolean("support_torch", true);
    }

    public static int getUserMode() {
        return C0004SystemProperties.getInt("persist.sys.user_mode", 0);
    }

    public static void setUserMode(Context context, int mode) {
        C0004SystemProperties.set("persist.sys.user_mode", Integer.toString(mode));
        C0015Build.reboot(false, null, false);
    }
    ...
    public static String getCustVariant() {
        if (IS_INTERNATIONAL_BUILD) {
            return C0004SystemProperties.get("ro.miui.cust_variant", "hk");
        }
        return C0004SystemProperties.get("ro.miui.cust_variant", "cn");
    }

    private static String getUserdataImageVersionCode() {
        if ("".equals(C0004SystemProperties.get("ro.miui.userdata_version", ""))) {
            return "Unavailable";
        }
        String region;
        if (IS_INTERNATIONAL_BUILD) {
        ...
        String carrier = C0004SystemProperties.get("ro.carrier.name", "");
        if (!"".equals(carrier)) {
