...
public class PreferenceFragment extends android.preference.PreferenceFragment implements IFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        View onCreateView = this.xd.onCreateView(viewGroup, bundle);
    ...
    public void invalidateOptionsMenu() {
        if (this.xd != null) {
            ...
            if (!isHidden() && this.xe && this.xf && isAdded()) {
                this.xd.invalidateOptionsMenu();
            }
        }
    }
    ...
    public void updateOptionsMenuContent() {
        if (this.xd != null && !isHidden() && this.xe && this.xf && isAdded()) {
            this.xd.invalidateOptionsMenu();
        }
    }
    ...
    public boolean onCreatePanelMenu(int i, Menu menu) {
        ...
        if (this.xe && this.xf && !isHidden() && isAdded()) {
    ...
    public void onPreparePanel(int i, View view, Menu menu) {
        if (i == 0 && this.xe && this.xf && !isHidden() && isAdded()) {
