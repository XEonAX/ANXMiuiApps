...
/* renamed from: com.google.gson_nex.internal.$Gson$Types */
        ...
        while (true) {
            ...
            if (type3 instanceof TypeVariable) {
                ...
                for (int i3 = 0; i3 < length; i3++) {
                    Type resolve3 = C$Gson$Types.resolve(type, cls, typeArr[i3]);
                ...
                if (i2 != 0) {
                    return C$Gson$Types.newParameterizedTypeWithOwner(resolve2, parameterizedType.getRawType(), typeArr);
                }
                ...
                if (typeArr.length == 1) {
                    ...
                    componentType = C$Gson$Types.resolve(type, cls, actualTypeArguments[0]);
                    if (componentType != actualTypeArguments[0]) {
