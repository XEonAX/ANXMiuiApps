...
final class MatrixUtil {
    ...
    private static final int[][] POSITION_ADJUSTMENT_PATTERN_COORDINATE_TABLE = new int[][]{new int[]{-1, -1, -1, -1, -1, -1, -1}, new int[]{6, 18, -1, -1, -1, -1, -1}, new int[]{6, 22, -1, -1, -1, -1, -1}, new int[]{6, 26, -1, -1, -1, -1, -1}, new int[]{6, 30, -1, -1, -1, -1, -1}, new int[]{6, 34, -1, -1, -1, -1, -1}, new int[]{6, 22, 38, -1, -1, -1, -1}, new int[]{6, 24, 42, -1, -1, -1, -1}, new int[]{6, 26, 46, -1, -1, -1, -1}, new int[]{6, 28, 50, -1, -1, -1, -1}, new int[]{6, 30, 54, -1, -1, -1, -1}, new int[]{6, 32, 58, -1, -1, -1, -1}, new int[]{6, 34, 62, -1, -1, -1, -1}, new int[]{6, 26, 46, 66, -1, -1, -1}, new int[]{6, 26, 48, 70, -1, -1, -1}, new int[]{6, 26, 50, 74, -1, -1, -1}, new int[]{6, 30, 54, 78, -1, -1, -1}, new int[]{6, 30, 56, 82, -1, -1, -1}, new int[]{6, 30, 58, 86, -1, -1, -1}, new int[]{6, 34, 62, 90, -1, -1, -1}, new int[]{6, 28, 50, 72, 94, -1, -1}, new int[]{6, 26, 50, 74, 98, -1, -1}, new int[]{6, 30, 54, 78, 102, -1, -1}, new int[]{6, 28, 54, 80, 106, -1, -1}, new int[]{6, 32, 58, 84, BaiduSceneResult.CASTLE, -1, -1}, new int[]{6, 30, 58, 86, BaiduSceneResult.BRIDGE, -1, -1}, new int[]{6, 34, 62, 90, BaiduSceneResult.SUBWAY, -1, -1}, new int[]{6, 26, 50, 74, 98, 122, -1}, new int[]{6, 30, 54, 78, 102, BaiduSceneResult.ID_CARD, -1}, new int[]{6, 26, 52, 78, 104, BaiduSceneResult.VISA, -1}, new int[]{6, 30, 56, 82, 108, BaiduSceneResult.SCREEN_TEXT, -1}, new int[]{6, 34, 60, 86, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.COSMETICS, -1}, new int[]{6, 30, 58, 86, BaiduSceneResult.BRIDGE, BaiduSceneResult.DIGITAL_PRODUCT, -1}, new int[]{6, 34, 62, 90, BaiduSceneResult.SUBWAY, 146, -1}, new int[]{6, 30, 54, 78, 102, BaiduSceneResult.ID_CARD, 150}, new int[]{6, 24, 50, 76, 102, 128, 154}, new int[]{6, 28, 54, 80, 106, BaiduSceneResult.VARIOUS_TICKETS, 158}, new int[]{6, 32, 58, 84, BaiduSceneResult.CASTLE, BaiduSceneResult.APPAREL, 162}, new int[]{6, 26, 54, 82, BaiduSceneResult.CASTLE, BaiduSceneResult.COSMETICS, 166}, new int[]{6, 30, 58, 86, BaiduSceneResult.BRIDGE, BaiduSceneResult.DIGITAL_PRODUCT, 170}};
