...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(1, BaiduSceneResult.ANCIENT_CHINESE_ARCHITECTURE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(2, BaiduSceneResult.CAR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(4, BaiduSceneResult.GARDEN));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, BaiduSceneResult.BUILDING_OTHER), new ECB(1, BaiduSceneResult.CAR));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(1, BaiduSceneResult.GARDEN), new ECB(5, BaiduSceneResult.ANCIENT_CHINESE_ARCHITECTURE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, BaiduSceneResult.MOTORCYCLE), new ECB(1, BaiduSceneResult.STATION));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, BaiduSceneResult.FOUNTAIN), new ECB(4, BaiduSceneResult.BRIDGE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(3, BaiduSceneResult.GARDEN), new ECB(5, BaiduSceneResult.ANCIENT_CHINESE_ARCHITECTURE));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(4, BaiduSceneResult.CAR), new ECB(4, BaiduSceneResult.FERRY));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(2, BaiduSceneResult.WESTERN_ARCHITECTURE), new ECB(7, BaiduSceneResult.STREET_VIEW));
        ...
        iArr = new int[]{6, 30, 54, 78, BaiduSceneResult.TAEKWONDO};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, BaiduSceneResult.STATION), new ECB(5, 122));
        ...
        iArr = new int[]{6, 28, 54, 80, BaiduSceneResult.PALACE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, BaiduSceneResult.FERRY), new ECB(4, BaiduSceneResult.SUBWAY));
        ...
        iArr = new int[]{6, 32, 58, 84, BaiduSceneResult.CASTLE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(26, new ECB(8, BaiduSceneResult.PALACE), new ECB(4, BaiduSceneResult.GARDEN));
        ...
        iArr = new int[]{6, 30, 58, 86, BaiduSceneResult.BRIDGE};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(28, new ECB(10, BaiduSceneResult.BRIDGE), new ECB(2, BaiduSceneResult.BUILDING_OTHER));
        ...
        iArr = new int[]{6, 34, 62, 90, BaiduSceneResult.SUBWAY};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(8, 122), new ECB(4, BaiduSceneResult.TRAIN));
        ...
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(3, BaiduSceneResult.FERRY), new ECB(10, BaiduSceneResult.SUBWAY));
        ...
        iArr = new int[]{6, 30, 54, 78, BaiduSceneResult.TAEKWONDO, BaiduSceneResult.ID_CARD};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(7, BaiduSceneResult.CAR), new ECB(7, BaiduSceneResult.FERRY));
        ...
        iArr = new int[]{6, 26, 52, 78, BaiduSceneResult.SPORTS_OTHER, BaiduSceneResult.VISA};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(5, BaiduSceneResult.BUILDING_OTHER), new ECB(10, BaiduSceneResult.CAR));
        ...
        iArr = new int[]{6, 30, 56, 82, BaiduSceneResult.ANCIENT_CHINESE_ARCHITECTURE, BaiduSceneResult.SCREEN_TEXT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, BaiduSceneResult.BUILDING_OTHER), new ECB(3, BaiduSceneResult.CAR));
        ...
        iArr = new int[]{6, 34, 60, 86, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.COSMETICS};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, BaiduSceneResult.BUILDING_OTHER));
        ...
        iArr = new int[]{6, 30, 58, 86, BaiduSceneResult.BRIDGE, BaiduSceneResult.DIGITAL_PRODUCT};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, BaiduSceneResult.BUILDING_OTHER), new ECB(1, BaiduSceneResult.CAR));
        ...
        iArr = new int[]{6, 34, 62, 90, BaiduSceneResult.SUBWAY, 146};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(13, BaiduSceneResult.BUILDING_OTHER), new ECB(6, BaiduSceneResult.CAR));
        ...
        iArr = new int[]{6, 30, 54, 78, BaiduSceneResult.TAEKWONDO, BaiduSceneResult.ID_CARD, 150};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(12, BaiduSceneResult.STATION), new ECB(7, 122));
        ...
        iArr = new int[]{6, 24, 50, 76, BaiduSceneResult.TAEKWONDO, 128, 154};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(6, BaiduSceneResult.STATION), new ECB(14, 122));
        ...
        iArr = new int[]{6, 28, 54, 80, BaiduSceneResult.PALACE, BaiduSceneResult.VARIOUS_TICKETS, 158};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(17, 122), new ECB(4, BaiduSceneResult.TRAIN));
        ...
        iArr = new int[]{6, 32, 58, 84, BaiduSceneResult.CASTLE, BaiduSceneResult.APPAREL, 162};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(4, 122), new ECB(18, BaiduSceneResult.TRAIN));
        ...
        iArr = new int[]{6, 26, 54, 82, BaiduSceneResult.CASTLE, BaiduSceneResult.COSMETICS, 166};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(20, BaiduSceneResult.FERRY), new ECB(4, BaiduSceneResult.SUBWAY));
        ...
        iArr = new int[]{6, 30, 58, 86, BaiduSceneResult.BRIDGE, BaiduSceneResult.DIGITAL_PRODUCT, 170};
        eCBlocksArr = new ECBlocks[4];
        eCBlocksArr[0] = new ECBlocks(30, new ECB(19, BaiduSceneResult.SUBWAY), new ECB(6, BaiduSceneResult.BICYCLE));
