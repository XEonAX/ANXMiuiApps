...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 30, 54, 78, 102, BaiduSceneResult.ID_CARD};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 52, 78, 104, BaiduSceneResult.VISA};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 56, 82, 108, BaiduSceneResult.SCREEN_TEXT};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 30, 54, 78, 102, BaiduSceneResult.ID_CARD, 150};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, 106, BaiduSceneResult.VARIOUS_TICKETS, 158};
        eCBlocksArr = new ECBlocks[4];
