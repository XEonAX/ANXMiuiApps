...
public class GalleryErrorCode {
    ...
    static {
        ...
        sExceptionMap.put(IllegalBlockSizeException.class, Integer.valueOf(MipubErrCode.RESULT_ERROR_AUTH_FAIL));
        sExceptionMap.put(BadPaddingException.class, Integer.valueOf(MipubErrCode.RESULT_ERROR_NETWORK_ERROR));
        sExceptionMap.put(JSONException.class, Integer.valueOf(MipubErrCode.RESULT_ERROR_SERVER_ERROR));
