...
public class ListMenuItemView extends LinearLayout implements ItemView {
    ...
    public void setCheckable(boolean checkable) {
        ...
        if (checkable || this.mRadioButton != null || this.mCheckBox != null) {
            ...
            MarginLayoutParams lp = (MarginLayoutParams) this.mRelativeLayout.getLayoutParams();
            if (!(checkable && this.mItemData.isExclusiveCheckable())) {
                startMargin = AttributeResolver.resolveDimensionPixelSize(getContext(), 16843683);
            }
            lp.setMarginStart(startMargin);
            this.mRelativeLayout.setLayoutParams(lp);
