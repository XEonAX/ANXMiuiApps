...
public class HomePageAdapter extends PreloadMediaAdapter implements CheckableAdapter, StickyGridHeadersBaseAdapter {
    ...
    public HomePageAdapter(Context context, DisplayScene type) {
        super(context, type);
    }
    ...
    private void bindContentDescription(View item, int position) {
        ...
        item.setContentDescription(TalkBackUtil.getContentDescriptionForImage(item.getContext(), cursor.getLong(3), cursor.getString(4), cursor.getString(8)));
    }
