...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
    ...
    /* renamed from: com.miui.gallery.hybrid.pulltorefresh.PullToRefreshBase$3 */
    ...
    protected final void onRestoreInstanceState(Parcelable state) {
        if (state instanceof Bundle) {
            ...
            State viewState = State.mapIntToValue(bundle.getInt("ptr_state", 0));
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        } else if (a.hasValue(17)) {
            background = a.getDrawable(17);
            if (background != null) {
                this.mRefreshableView.setBackgroundDrawable(background);
            }
        }
        ...
        if (a.hasValue(16)) {
            this.mMaximumPullScroll = a.getDimensionPixelOffset(16, 0);
        }
    ...
    private int getMaximumPullScroll() {
        switch (getPullToRefreshScrollDirection()) {
            ...
            default:
                if (this.mMaximumPullScroll != 0) {
                    return this.mMaximumPullScroll;
                }
