...
public class FontResDownloadManager {
    ...
    public void download(FontBean resource, String downloadPath, final Listener listener, final boolean isActiveNetworkMetered) {
        ...
        request.execute(new ResponseListener() {
            public void onResponse(Object... response) {
                ...
                FontResDownloadManager.this.mRequestList.add(downloadRequest);
