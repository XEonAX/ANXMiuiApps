...
public enum FileType {
    ...
    SVG((String) FileCategory.Image, (int) new String[]{"svg"}, (FileCategory) new int[][]{new int[]{60, BaiduSceneResult.BUILDING_OTHER, BaiduSceneResult.SUBWAY, 103}, new int[]{60, 83, 86, 71}}),
    ...
    M4A((String) FileCategory.Audio, (int) new String[]{"m4a"}, (FileCategory) new int[][]{new int[]{0, 0, 0, 32, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 77, 52, 65, 32}, new int[]{-1, -1, -1, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 77, 52, 65, 32}}),
    M4V((String) FileCategory.Video, (int) new String[]{"m4v"}, (FileCategory) new int[][]{new int[]{0, 0, 0, 24, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.CHURCH, BaiduSceneResult.STREET_VIEW, 52, 50}, new int[]{-1, -1, -1, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.CHURCH, BaiduSceneResult.STREET_VIEW, 52, 50}}),
    MP4((String) FileCategory.Video, (int) new String[]{"mp4"}, (FileCategory) new int[][]{new int[]{0, 0, 0, 20, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 105, BaiduSceneResult.BUILDING_OTHER, BaiduSceneResult.WESTERN_ARCHITECTURE, BaiduSceneResult.CHURCH}, new int[]{0, 0, 0, 24, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 105, BaiduSceneResult.BUILDING_OTHER, BaiduSceneResult.WESTERN_ARCHITECTURE, BaiduSceneResult.CHURCH}, new int[]{0, 0, 0, 24, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 51, 103, BaiduSceneResult.STREET_VIEW, 53}, new int[]{0, 0, 0, 28, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 77, 83, 78, 86, 1, 41, 0, 70, 77, 83, 78, 86, BaiduSceneResult.CHURCH, BaiduSceneResult.STREET_VIEW, 52, 50}, new int[]{-1, -1, -1, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 51, 103, BaiduSceneResult.STREET_VIEW, 53}, new int[]{-1, -1, -1, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 77, 83, 78, 86}, new int[]{-1, -1, -1, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 105, BaiduSceneResult.BUILDING_OTHER, BaiduSceneResult.WESTERN_ARCHITECTURE, BaiduSceneResult.CHURCH}, new int[]{0, 0, 0, 24, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.CHURCH, BaiduSceneResult.STREET_VIEW, 52, 49}}),
    F_3GP((String) FileCategory.VideoOrAudio, (int) new String[]{"3gp", "3gpp", "3g2"}, (FileCategory) new int[][]{new int[]{0, 0, 0, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 51, 103, BaiduSceneResult.STREET_VIEW}, new int[]{0, 0, 0, -1, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, 51, 103, 50}}),
    ...
    MOV((String) FileCategory.Video, (int) new String[]{"mov"}, (FileCategory) new int[][]{new int[]{0, 0, 0, 20, 102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.FOUNTAIN, BaiduSceneResult.CAR, 32, 32}, new int[]{102, BaiduSceneResult.CAR, BaiduSceneResult.STATION, BaiduSceneResult.STREET_VIEW, BaiduSceneResult.FOUNTAIN, BaiduSceneResult.CAR, 32, 32}, new int[]{-1, -1, -1, -1, BaiduSceneResult.CHURCH, BaiduSceneResult.WESTERN_ARCHITECTURE, BaiduSceneResult.WESTERN_ARCHITECTURE, BaiduSceneResult.SUBWAY}}),
    WMV((String) FileCategory.Video, (int) new String[]{"wmv"}, (FileCategory) new int[][]{new int[]{48, 38, 178, BaiduSceneResult.FERRY, BaiduSceneResult.DIGITAL_PRODUCT, 102, 207, 17, 166, 217, 0, 170, 0, 98, 206, 108}}),
